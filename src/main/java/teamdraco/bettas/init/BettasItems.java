...
public class BettasItems {
    ...
    public static final RegistryObject<BettasSpawnEggItem> BETTA_FISH_SPAWN_EGG = ITEMS.register("betta_fish_spawn_egg", () -> new BettasSpawnEggItem(BettasEntities.BETTA_FISH, 0x613d2a, 0x2dceff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
