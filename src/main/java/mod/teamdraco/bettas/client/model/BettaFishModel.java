...
public class BettaFishModel<T extends Entity> extends EntityModel<T> {
    ...
    public BettaFishModel() {
        ...
        this.finLeftBottom.setRotationPoint(0.5F, 1.5F, -0.5F);
        ...
        this.finRight.setRotationPoint(-1.0F, 0.5F, -0.5F);
        ...
        this.finLeft.setRotationPoint(1.0F, 0.5F, -0.5F);
